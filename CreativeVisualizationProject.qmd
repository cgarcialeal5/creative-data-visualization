...
pc_basemap_plot <- ggplot() +
  ...
  geom_raster(
    data = pc_kde_df,
    aes(x = x, y = y, fill = value, alpha = value),
    alpha = 0.6
  ) +
  scale_fill_viridis_c(option = "D") +
  scale_alpha_continuous(
    range = c(0.00, 1.00),
    limits = c(0.000, 0.005),
    guide = "none"
  ) +
  coord_fixed() +
